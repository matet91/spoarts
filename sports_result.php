...
<html>
			...
			<script>
				...
				function display(d)
				{
					...
					for (var i = 0; i < result2.length; i++) 
					{
						...
						function dis(e)
						{
							$('#displayServiceName').append(" " + e.ServiceName + " ");
						}
					});
								$('#displaySportsClinics').append(
										'<div class="col s12">'
								          +'<div class="card small">'
								            ...
								            +'<div class="card-content">'
								              ...
								              +'<p>Offered Services: <span id="displayServiceName"></span>.</p>'
	...
	<body>
		...
		<div class="row">
			...
			<div class="col s9">
		    	<div class="section">
			 	  	 <div class="row" id="displaySportsClinics">
